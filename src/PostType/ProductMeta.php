 ...
 *
 * listings/extras はネイティブ配列メタ（type=array）として保存し、Gutenberg の
 * useEntityProp が実配列で読み書きできるようにする。フィールド形状の権威は
 * ProductSchema::sanitize* に置き、show_in_rest スキーマは item=object の柔軟型とする。
